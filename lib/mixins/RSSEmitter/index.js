...
var mixinFunctions = {
	...
	RSSEmitter_createFeed: function(id, name, url, interval, options, callback){
		...
		if(!err){
			...
			thisNode.on('RSSEmitter.Feeds.'+id+'.Start', thisNode.RSSEmitter_onStartById);
			thisNode.on('RSSEmitter.Feeds.'+id+'.Stop', thisNode.RSSEmitter_onStopById);
			thisNode.on('RSSEmitter.Feeds.'+id+'.Remove', thisNode.RSSEmitter_onRemoveById);
			thisNode.on('RSSEmitter.Feeds.'+id+'.Fetch', thisNode.RSSEmitter_onFetchById);
	...
	RSSEmitter_onStartById: function(message, rawMessage){
		var thisNode = this;
		thisNode.RSSEmitter_startFeed(message.id);
	},
	RSSEmitter_onStopById: function(message, rawMessage){
		var thisNode = this;
		thisNode.RSSEmitter_stopFeed(message.id);
	},
	RSSEmitter_onRemoveById: function(message, rawMessage){
		var thisNode = this;
		thisNode.RSSEmitter_removeFeed(message.id);
	},
	RSSEmitter_onFetchById: function(message, rawMessage){
		var thisNode = this;
		thisNode.RSSEmitter_fetchFeed(message.id);
	}
}
