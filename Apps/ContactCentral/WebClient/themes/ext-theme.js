(function() {
    ...
    function u(url) {
        return uki.theme.ExtTheme.imagePath + url;
    }

    uki.theme.ExtTheme = uki.extend({}, uki.theme.Base, {
        imagePath: 'i/',
        ...
        backgrounds: {
            ...
            'toolbar-button-down': function() {
                return new uki.background.CssBox('border:1px solid #333;background:url(' + uki.theme.imageSrc('toolbar-button-down') + ')');
            },
    ...
    uki.theme.ExtTheme.backgrounds['button-hover'] = uki.theme.ExtTheme.backgrounds['button-normal'];
    uki.theme.ExtTheme.backgrounds['a-button-hover'] = uki.theme.ExtTheme.backgrounds['a-button-normal'];
    uki.theme.ExtTheme.backgrounds['plus-button-hover'] = uki.theme.ExtTheme.backgrounds['plus-button-normal'];
    uki.theme.ExtTheme.backgrounds['plus-big-button-hover'] = uki.theme.ExtTheme.backgrounds['plus-big-button-normal'];
    uki.theme.ExtTheme.backgrounds['search-button-down'] = uki.theme.ExtTheme.backgrounds['search-button-hover'] = uki.theme.ExtTheme.backgrounds['search-button-normal'];
    uki.theme.ExtTheme.backgrounds['link-button-down'] = uki.theme.ExtTheme.backgrounds['link-button-hover'] = uki.theme.ExtTheme.backgrounds['link-button-normal'];
    uki.theme.ExtTheme.backgrounds['toolbar-popup'] = uki.theme.ExtTheme.backgrounds['popup-normal'];
    uki.theme.ExtTheme.backgrounds['toolbar-popup-button-down'] = uki.theme.ExtTheme.backgrounds['toolbar-popup-button-hover'];
    
    uki.theme.register(uki.theme.ExtTheme);
})();