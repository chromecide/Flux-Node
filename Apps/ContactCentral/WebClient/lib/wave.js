...
function menuButton (label, offset, rect) {
    return uki.extend(toolbarButton(label, offset), { view: 'Button', id: 'button'+label, style: { textAlign: 'left', fontSize: '13px', fontWeight: 'normal', color: '' }, rect: rect, backgroundPrefix: 'link-button-', focusable: 'false', anchors: 'left top right', inset: '0 8 0 30', focusable: false });
}
...
uki({
            		...
            		childViews: [
                		{
                			...
                			childViews: [ 
                    			menuButton('Accounts', '-160px 0', '0 2 166 24'), 
                    			menuButton('Rules', '-192px 0', '0 0 166 24'), 
        	...
        	childViews: [
            	{
            		...
            		childViews: [
                		...
                		},
                		{
                			...
                			rect: '139 46 13 13',
                			anchors: 'right top',
                			backgroundPrefix: 'search-button-',
                			focusable: false
                		}
            		] 
            	},
    ...
    rightChildViews: {
        ...
        leftChildViews: panel('Inbox 1 - 4 of 4', { 
        	rect: '300 930', 
        	childViews: [
            	{ view: 'Box', rect: '0 23 300 56', background: 'theme(box-lblue)', anchors: 'left top right', 
            		childViews: [
...
uki('#buttonAccounts').click(function(){
	alert('here');
});
